...
We wrote our code for this project within a fork of the existing [erlerobot gym-gazebo fork of OpenAI Gym](https://github.com/erlerobot/gym-gazebo). Our documentation is avaialble on the [website associated with this repository](https://anushadatar.github.io/gym-gazebo-hide-and-seek/). While we did a variety of experimetns and made some modifications throughtou the fork, we also created a core hide and seek [algorithm script](https://github.com/anushadatar/gym-gazebo-hide-and-seek/blob/master/gym_gazebo/envs/turtlebot/gazebo_maze_multi_turtlebot_lidar.py) and [orchestration script](https://github.com/anushadatar/gym-gazebo-hide-and-seek/blob/master/examples/turtlebot/maze_multi_turtlebot_lidar_qlearn.py). We also wrote a [start script](https://github.com/anushadatar/gym-gazebo-hide-and-seek/blob/master/examples/turtlebot/start.sh) for quickly demonstrating this functionality and a [camera script](https://github.com/anushadatar/gym-gazebo-hide-and-seek/blob/master/examples/turtlebot/cameras.sh) for quick access to the two robot cameras.

---
# Original README associated with [gym-gazebo](https://github.com/erlerobot/gym-gazebo) included below
